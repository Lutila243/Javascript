...
document.getElementById("cal").style.display = "none";
 ...
 19, 0, 0); // all launches at 8:00pm UTC
  ...
  if ((dateTo - dateFrom) < 1000) { // time will be less than 0
 //when setInterval runs next
 ...
 ":" + secondsUntil;
  ...
  function registerName() {
								 ...
								 passengerName.innerHTML = ticket.passengers[newFnameProp] + " " +
								 ticket.passengers[newLnameProp];
								 ...
								 document.getElementById("passengersSection").style.display =
								 "block";
...
function createEventListeners() 
{
 ...
 for (var i = 0; i < dateCells.length; i++) {
 dateCells[i].addEventListener("click", selectDate,
 false);
 }
...
}//create createEventlistener end
